  ...
  products: [
    {
      ...
      desc: "",
      bullets: ["Working capital", "Machinery", "Overdraft / Cash Credit", "Secured & Unsecured term loans"],
      ticket: "₹20 L – ₹5 Cr",
    },
    {
      code: "CP-02",
  ...
  steps: [
    {
      ...
      body: "Cash flows, sector, growth stage, funding needs.",
    },
    {
      n: "02",
      title: "Human context",
      body: "Seasonality, financing need, business context behind the numbers.",
    },
    {
      n: "03",
      title: "AI matching engine",
      body: "Best-fit lender recommendation / navigation layer.",
    },
    {
      n: "04",
      title: "Offer + recommendation",
      body: "Borrower chooses, Capitabel fulfills.",
    },
  ],
  engineFacts: [
