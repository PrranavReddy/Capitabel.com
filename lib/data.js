...
export const landing = {
  ...
  engineFacts: [
    { val: "10–12", label: "Core lender partners, rationalised from 40+" },
  ...
  clusters: [
    { tag: "Anchor · 60%", name: "Chennai", target: "₹120 Cr" },
    { tag: "Tier 2 · Andhra", name: "Nellore", target: "₹20 Cr" },
    { tag: "Cluster · 5 towns", name: "South Andhra", target: "₹10 Cr" },
    { tag: "Industrial · SIPCOT", name: "North Chennai", target: "₹10 Cr" },
    { tag: "FY 26–27 · TBD", name: "Fifth cluster", target: "₹40 Cr" },
  ],
  posts: [
  ...
  faqs: [
    ...
    },
    {
      ...
      a: "A rationalised core panel of 10–12 institutions drawn from a wider network of 40+. It includes HDFC, ICICI, KVB, IOB, Central Bank, Canara, Repco Home Finance, Tata Capital, Bajaj Housing, and specialised MSME/HFC lenders like HomeFirst, Muthoot, and Piramal.",
    },
    {
...
export const about = {
  stats: [
    ...
    { val: "5", tag: "Clusters", label: "Geographic clusters across Tamil Nadu and Andhra Pradesh" },
  ],
  pillars: [
    {
      n: "01",
      tag: "Grow",
      title: "Scale to ₹200 Cr",
      body: "Across five geographic clusters through structured expansion of team, lender relationships, and sourcing channels. From ₹9.6 Cr March run rate to ₹22 Cr+ by Q4.",
    },
    {
      n: "02",
      tag: "Build",
      title: "Ship the Matching Engine",
      body: "Borrower profile to top three lenders in minutes. Cut time-to-Capitabel-Loan-Offer from seven days to forty-eight hours by Q3.",
    },
    {
      n: "03",
      tag: "Deepen",
      title: "Shift product mix",
      body: "Grow MSME to 25% of volume. Deepen LAP to 10%. Higher commission yields drive profitability per crore disbursed — 0.59% blended today, 1.20–1.40% target.",
    },
    {
      n: "04",
      tag: "Institutionalise",
      title: "Make Capitabel investor-ready",
      body: "Formalise the Matching Engine Framework with Thiru, SOPs, governance, and KPIs. Angel round close by Q3, seed conversations early FY 2027–28.",
    },
  ],
  team: [
    {
    ...
    {
      img: "/images/thiru-r.jpg",
      role: "Strategic Advisor",
      name: "Thiru.R",
      bio: "25 years in MSME and inclusive lending. Former COO and Board Member at Kinara Capital (12.5 years). Earlier: Mimo Finance, Dhan Foundation, Sir Ratan Tata Trust. Harvard Business School — Strategic Leadership Programme.",
  ...
  timeline: [
    { year: "2023", title: "Capitabel incorporated.", body: "Chidambaram and Harish co-found the business in Chennai, under the Manor Group umbrella." },
    { year: "Sep 2023", title: "Devesh joins as founding member.", body: "Partnerships lead. First bank and NBFC partnerships closed, operations infrastructure built from zero." },
    { year: "FY 2024–25", title: "First ₹25 Cr cumulative disbursed.", body: "Core lender relationships established across 20+ banks and NBFCs. Chennai anchor operating steadily." },
    { year: "FY 2025–26", title: "₹50.15 Cr cumulative · 52 files closed.", body: "March 2026 monthly run rate reaches ₹9.6 Cr. Mutu and Nagindra onboard for Andhra expansion." },
    { year: "Q1 FY 26–27", title: "Nellore branch · Matching Engine Alpha.", body: "Nellore branch activation. Claude–Zoho integration goes live as the intelligence layer of the Matching Engine. Framework delivered with Thiru." },
    { year: "Q3 FY 26–27", title: "Engine production · Angel round.", body: "South Andhra expansion to 5 towns. Matching Engine in production. Joggle embedded finance pilot. Angel round closed (₹3–4 Cr)." },
    { year: "Q4 FY 26–27", title: "₹200 Cr milestone · ₹1 Cr profit.", body: "Full-year disbursement target achieved. First full profitable year. Seed round preparation begins." },
  ],
  beliefs: [
    {
      n: "01",
...
export const loans = {
  summary: [
    { label: "Core panel", val: "10–12", note: "Lenders on active core panel" },
    { label: "Wider network", val: "40+", note: "Banks and NBFCs reachable" },
