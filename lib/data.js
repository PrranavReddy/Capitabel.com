...
export const calculators = [
  {
    ...
    tag: "General",
    desc: "Work out the EMI, interest, and full amortisation schedule for any term loan — immediate repayment or with a construction moratorium, with staged disbursement.",
  },
  {
  ...
  posts: [
    {
      ...
      excerpt:
        "RBI has proposed restricting NBFCs to term loans only, barring revolving credit products like flexi loans and overdraft-style facilities. It's still a draft — here's what's actually in it.",
      sections: [
        {
        ...
        },
        {
          ...
          body: [
            "If finalised as drafted, this reaches further than consumer credit lines. Industry body FIDC (Finance Industry Development Council) has flagged that a blanket ban could disrupt working-capital products MSMEs rely on — overdraft-style facilities and loans against securities included — not just the higher-risk retail flexi products the rule seems aimed at.",
            [
    ...
    },
    {
      ...
      read: "5 min read",
      date: "3 September 2026",
      title: "The insurance quietly bundled into your home loan — and what it's actually costing you",
      excerpt:
      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            "Insurance sold alongside a loan generates a commission for whoever sells it, and bundling it in at sanction stage — when a borrower is focused on getting the loan closed, not scrutinising every line of the KFS — makes it far more likely to go through unquestioned than if it were offered as a separate, optional purchase.",
          ],
        },
        {
